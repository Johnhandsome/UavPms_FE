...
const DEFAULT_FALLBACK_REPORTS: readonly ReportItem[] = [
  {
    ...
    creator: { id: 'c-1', fullName: 'Nguyễn Văn An (Kỹ sư AI)' },
    creatorName: 'Nguyễn Văn An (Kỹ sư AI)',
    status: 'approved',
    statusName: 'Đã duyệt',
    fileSizePdf: 5033164,
  ...
  },
  {
    ...
    creator: { id: 'c-2', fullName: 'Trần Đình Trọng (Phi công UAV)' },
    creatorName: 'Trần Đình Trọng (Phi công UAV)',
    status: 'approved',
    statusName: 'Đã duyệt',
